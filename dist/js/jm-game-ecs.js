...
},{"./area":1,"./player":3,"jm-ecs":10,"jm-logger":19,"jm-utils":20,"lodash":21}],3:[function(require,module,exports){
'use strict';
...
var EM = function (_Obj) {
  ...
  _createClass(EM, [{
    ...
    value: function createEntity(type, opts, parent) {
      ...
      var _opts = opts;
      opts = {};
      opts = _lodash2.default.cloneDeep(this._entityTypes[type]);
      if (_opts) {
        opts = _lodash2.default.merge(opts, _lodash2.default.cloneDeep(_opts));
      }
    ...
    value: function removeEntity(entityId) {
      var e = void 0;
      if (_lodash2.default.isObject(entityId)) {
        e = entityId;
      } else {
